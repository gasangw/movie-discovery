...
function HomePage() {
  return (
    <div style={{backgroundImage: `url(${imageURL})`}} className='mb-8 bg-cover bg-no-repeat h-[80vh]'>
       <Nav />
       <div className='container text-white text-left'>
         ...
         <div className='flex gap-3 rounded-md bg-[#BE123C] text-white py-3 px-5 w-fit justify-center items-center mt-4'>
