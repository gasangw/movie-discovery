...
function Footer() {
  return (
    <div className='container flex flex-col justify-center items-center space-y-3 py-28'>
       ...
       <p className='text-base text-[#6B7280]'>© 2021 MovieBox by Adriana Eka Prayudha</p>
    </div>
  )
}
